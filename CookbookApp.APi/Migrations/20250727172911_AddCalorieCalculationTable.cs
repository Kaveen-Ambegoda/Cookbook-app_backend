...
{
    /// <inheritdoc />
    public partial class AddCalorieCalculationTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserFavorites_Forums_ForumId",
                        column: x => x.ForumId,
                        principalTable: "Forums",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaintenanceCalories = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    WeightLossCalories = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    WeightGainCalories = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    BMI = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    IdealWeightMin = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    IdealWeightMax = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ...
                    ProteinCalories = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CarbsCalories = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    FatCalories = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CalorieCalculations_UserProfiles_UserProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CalorieCalculations_CalculatedAt",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CalorieCalculations_UserProfileId",
                table: "CalorieCalculations",
